...
import { getUserInfo, isRegistered } from "../utils/sessionManagement";
  ...
  return (
    <>
      ...
      <div className="exam-info content">
        ...
        <p>{`Let's have a look at examination information`}</p>
        <ol>
        ...
        <ul className="exam-instructions">
          <li>You will get questions status summary at bottom of test screen</li>
          <li>
            <ul>
              <li>
